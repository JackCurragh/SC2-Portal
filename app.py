...
def index():
    ...
    return render_template('index.html', studies=studies, conditions=formatted_conditions, conditions_keys=condition_keys, condition_info=formatted_condition_info)
...
def format_conditions(conn, conditions):
    ...
    for condition in conditions:
        ...
        rename_dict = {'chx' : 'Cycloheximide', 'ltm':'Lactimidomycin', 'harr':'Harringtonine'}
