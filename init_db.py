...
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by) VALUES ('sra_run', 'SRA Run', '1', 'Sequence Read Archive Run ID', '10');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by, value_suffix) VALUES ('seq_type', 'Sequencing Type','1', 'Type of Sequencing Experiment Used to Produce Data', '3', '-Seq');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by, value_suffix) VALUES ('hpi', 'HPI', '1', 'Hours Post Infection', '5', ' Hours');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by, value_suffix) VALUES ('moi', 'MOI', '1', 'Multiplicity of Infection', '7', ' MOI');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by) VALUES ('host_cell', 'Host Cell Type', '1', 'The Cell line that the Study Was Carried Out In', '6');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by) VALUES ('treatment', 'Ribo-Seq Treatment Type', '1', 'Treatment used to Immobilize Ribosomes', '4');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by) VALUES ('elongating', 'Elongating Ribosomes', '1', 'Ribosomes Captured During Elongation Phase', '8');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by) VALUES ('initiating', 'Initiating Ribosomes', '1', 'Ribosomes Captured During Initiation Phase', '9');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by) VALUES ('study', 'Study', '1', 'The Study From Which the File Came From', '1');"
)
cur.execute(
    "INSERT INTO condition_info (condition, alias, class, info, order_by) VALUES ('sars_vs_mock', 'SARS Infected vs Mock', '1', 'Whether the Sample Was Control or SARS-CoV2 Infected', '2');"
)
